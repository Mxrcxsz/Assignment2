...
function fetchTop(url,number){
    ...
    for(var i = 0; i<data.top.length; i++)
    {
        ...
        $("#flex-container" + number).append("<div class='flex-items'><a href='details.html' onclick='showDetails(" + data.top[i].mal_id + ")'><div class='flex-items-container'><div class='imgContainer'><img src=" + data.top[i].image_url + "></div><article><div class='description'></div></article></div><p>" + data.top[i].title + "</p></a></div>");
    }
    });
}
...
if(page == "details.html"){
    $('#title').html(sessionStorage.getItem("ID"))
}